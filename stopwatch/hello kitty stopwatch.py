...
def main():
    ...
    Button(root, text='Start', font=('isocteur'), height=1, width=6, fg=('white'), bg=('#3b444b'), command=sw.Start).pack(side=LEFT)
    Button(root, text='Stop', font=('isocteur'), height=1, width=6, fg=('white'), bg=('#3b444b'), command=sw.Stop).pack(side=LEFT)
    Button(root, text='Reset', font=('isocteur'), height=1, width=6, fg=('white'), bg=('#3b444b'), command=sw.Reset).pack(side=LEFT)
    Button(root, text='Lap', font=('isocteur'), height=1, width=6, fg=('white'), bg=('#3b444b'), command=sw.Lap).pack(side=LEFT)
    Button(root, text='Clear', font=('isocteur'), height=1, width=5, fg=('white'), bg=('#3b444b'), command=sw.Clear).pack(side=LEFT)
